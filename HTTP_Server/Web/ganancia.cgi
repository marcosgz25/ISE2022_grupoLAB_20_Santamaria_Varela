...
c b c <option %s>Seleccione valor</option><option %s>Ganancia1</option>
c b c <option %s>Ganancia5</option><option %s>Ganancia10</option>
c b c <option %s>Ganancia50</option><option %s>Ganancia100</option></select></td></tr>
t </p></form>
i pg_footer.inc
